...
def make_transfer_metadata(
    *,
    ...
    cache_roles: list[str] | None = None,
    transfer_unit_tokens: list[int] | None = None,
    ...
    return MooncakeTransferMetadata(
        ...
        cache_roles=cache_roles or ["kv"] * num_layers,
        transfer_unit_tokens=transfer_unit_tokens or [16] * num_layers,
